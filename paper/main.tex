...
\title{Targeted Remasking: Replacing Token Editing with Token-to-Mask Refinement in Discrete Diffusion Language Models}
...
Table~\ref{tab:benchmark_details} lists all benchmarks used in our evaluation with dataset details and generation length settings.
...
\toprule
\textbf{Category} & \textbf{Benchmark} & \textbf{Split} & \textbf{Samples} & \textbf{Metric} & \textbf{Gen Length} \\
\midrule
\multirow{3}{*}{Knowledge}
& MMLU-Pro       & test  & 12,032  & Accuracy    & 1024 \\
& GPQA-Diamond   & train & 198     & Accuracy    & 1024 \\
& TriviaQA       & val   & 17,944  & EM / F1     & 256  \\
\midrule
\multirow{4}{*}{Reasoning}
& BIG-Bench Hard & test  & $\sim$6,500 & EM     & 512  \\
& HellaSwag      & val   & 10,042  & Accuracy    & 256  \\
& PIQA           & test  & 1,838   & Accuracy    & 256  \\
& DROP           & val   & 9,535   & EM / F1     & 256  \\
\midrule
\multirow{4}{*}{Math}
& GSM-Plus         & testmini & 2,400 & EM (numeric) & 512  \\
& CMATH            & test     & 1,098 & EM (numeric) & 512  \\
& AIME 2025        & --       & 30    & EM (integer) & 16384 \\
& OlympiadBench    & test     & 674   & Math match   & 1024 \\
\midrule
\multirow{2}{*}{Coding}
& HumanEval+ & --  & 164 & pass@1 & 512 \\
& MBPP+      & --  & 378 & pass@1 & 512 \\
\bottomrule
\end{tabular}
\end{table}
...
\textit{[To be filled with specific examples showing T2T failure and T2M success after running experiments.]}
